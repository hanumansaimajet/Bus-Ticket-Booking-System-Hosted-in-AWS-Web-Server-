...
<section id="contact">
  ...
  <div class="row">
	<div class="well" style="margin: 0px 20px 0px 20px; background-color: #cbcbcb;">
		...
		<p>1.You can capable of booking ticket when you are become a user of our system(first sign in and then logged in).</p>
		...
		<div class="w3-row w3-container">
		  <div class="w3-col s4 w3-green w3-center">
			<div class="card">
			  ...
			  <h2>Surya Prakash</h2>
			  <p class="title">St. ID: 19BPS1052</p>
			  <p>Institution: VITCC</p>
		  ...
		  <div class="w3-col s4 w3-dark-grey w3-center">
			<div class="card">
			  ...
			  <h2>ANIL</h2>
			  <p class="title">St. ID: 19BPS1047</p>
			  <p>Institution: VITCC</p>
		  ...
		  <div class="w3-col s4 w3-green w3-center">
			<div class="card">
			  ...
			  <h2>Hanuman</h2>
			  <p class="title">St. ID: 19BPS1066</p>
			  <p>Institution: VITCC</p>
...
OBRS is a system that helps people to buy their ticket at home thought the help of any device capable of browsing.
terms & condition
1.You can capable of booking ticket when you are become a user of our system(first sign in and then logged in).
2.Yu can contact with us through contact button displayed at homepage.
3.Yu can not bus more than four ticket in a day.
...
ST. ID: 1420119
INSTITUTION: SASTC
Book,Travel,Enjoy & Make Memories
"Pay Less Live Large" -->
